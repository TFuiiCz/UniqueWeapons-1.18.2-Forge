...
public class WrathSummonedSkeleton extends Skeleton {
    private Player summoner;
    private int despawnTimer = 1200;
    private int lastAttackTime = 0;
    
    public WrathSummonedSkeleton(EntityType<? extends Skeleton> type, Level level) {
        super(type, level);
    ...
    private void setupSummonedMob() {
        ...
        if (!this.level.isClientSide) {
            this.addEffect(new net.minecraft.world.effect.MobEffectInstance(
                net.minecraft.world.effect.MobEffects.MOVEMENT_SPEED, 1200, 2, false, false));
            this.addEffect(new net.minecraft.world.effect.MobEffectInstance(
                net.minecraft.world.effect.MobEffects.DAMAGE_BOOST, 1200, 1, false, false));
            this.addEffect(new net.minecraft.world.effect.MobEffectInstance(
                net.minecraft.world.effect.MobEffects.JUMP, 1200, 1, false, false));
        }
        ...
        this.goalSelector.addGoal(2, new net.minecraft.world.entity.ai.goal.RangedBowAttackGoal<>(this, 1.0D, 20, 15.0F));
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, net.minecraft.world.entity.LivingEntity.class, 10, true, false, 
            (entity) -> {
                ...
                if (entity instanceof Player && entity != summoner && 
                    summoner != null && summoner.getLastHurtMob() == entity) {
                    return true;
                }
                return false;
            }));
    ...
    public void tick() {
        ...
        if (!this.level.isClientSide) {
            ...
            if (despawnTimer <= 0 && this.isAlive()) {
                for(int i = 0; i < 5; ++i) {
                    this.level.addParticle(net.minecraft.core.particles.ParticleTypes.SMOKE,
                        this.getRandomX(0.5D), this.getRandomY(), this.getRandomZ(0.5D),
                        0.0D, 0.1D, 0.0D);
            ...
            if (summoner != null && summoner.isAlive()) {
                ...
                if (summoner.getLastHurtByMob() != null && 
                    ...
                    this.setTarget(summoner.getLastHurtByMob());
                }
    ...
    private class FollowSummonerGoal extends Goal {
        private final WrathSummonedSkeleton mob;
        private final double speedModifier;
        private final float startDistance;
        private final float stopDistance;
        private int timeToRecalcPath;
        
        public FollowSummonerGoal(WrathSummonedSkeleton mob, double speedModifier, float startDistance, float stopDistance) {
            this.mob = mob;
